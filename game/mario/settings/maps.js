            ...
            "areas": [
                {
                    ...
                    "creation": [
                        ...
                        { "thing": "CustomText", "x": 0, "y": 48, "texts": [
                            { "text": "СПАСАЕМ ОТ АРМИИ С 2009 ГОДА", "offset": 4 }
                        ]},
                        { "thing": "CustomText", "x": 0, "y": 43, "texts": [
                            { "text": "ЕСЛИ НЕ ВЕРИШЬ ТО БЕГИ В УНИВЕР!", "offset": 4 }
                        ]},
                        { "thing": "CustomText", "x": 200, "y": 36, "texts": [
                            { "text": "СКОРО ЧИСТИТЬ ВИЛКОЙ УНИТАЗ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 750, "y": 44, "texts": [
                            { "text": "ТРАВА САМА СЕБЯ НЕ ПОКРАСИТ", "offset": 8 }
                        ]},
                        ...
                        { "thing": "CustomText", "x": 900, "y": 94, "texts": [
                            { "text": "НУ СХОДИ В АРМЕЙКУ НУ ЧЁ ТЫ ГОДИК ВСЕГО СЛОЖНО ЧТО ЛИ", "offset": 8 }
                        ]},
                        ...
                        { "thing": "Stone", "x": 1264, "y": 8 },
                         { "thing": "CustomText", "x": 1300, "y": 44, "texts": [
                            { "text": "АУ АУ АУ Я ТЕБЯ ВСЁ РАВНО НАЙДУ", "offset": 8 }
                        ]},
                        ...
                        { "thing": "Coin",  "x": 462,  "y": 44 },
                        { "thing": "Navalny", "x": 1620, "y": 64, "width": 32, "height": 64 },
                        { "thing": "CustomText", "x": 438, "y": 44, "texts": [
                            { "text": "В ТРУБЕ ВОЕННИК", "offset": 0 }
                        ]},
                        { "thing": "Univer", "x": 1522, "y": 56, "width": 64, "height": 24 },
                    ...
                    "creation": [
                        ...
                        { "thing": "CustomText", "x": 35, "y": 72, "texts": [
                            { "text": "ВОЕНКОМАТ", "offset": 8 }
                        ]},
                        { "thing": "Voenkom", "x": 36, "y": 68, "height": 32, "width": 48 },
                        { "macro": "Fill", "thing": "Brick", "x": 32, "y": 8, "xnum": 7, "ynum": 3, "xwidth": 8, "yheight": 8 },
                        { "macro": "Fill", "thing": "Goomba", "x": 33, "y": 31, "xnum": 7, "ynum": 2, "xwidth": 8, "yheight": 16 },
                        { "macro": "Fill", "thing": "Goomba", "x": 41, "y": 63, "xnum": 5, "ynum": 1, "xwidth": 8 },
            ...
            "areas": [
                {
                    ...
                    "creation": [
                        ...
                        { "macro": "CastleSmall" },
                        { "thing": "CustomText", "x": 48, "y": 24, "texts": [
                            { "text": "ПРИВЕТ КАК СЕССИЯ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 64, "y": 64, "texts": [
                            { "text": "ГДЕ ПРОЛЬЁТСЯ МОЯ КРОВЬ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 600, "y": 90, "texts": [
                            { "text": "ТОЛЬКО НА ДОНБАСС", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 926, "y": 46, "texts": [
                            { "text": "НЕ СЛУЖИЛ НЕ МУЖИК", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 1160, "y": 40, "texts": [
                            { "text": "ПОДСТАВЛЯЙ ЗАД", "offset": 8 },
                            { "text": "УКЛОНИСТ!", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 300, "y": 88, "texts": [
                            { "text": "НЕ ССЫ В СИРИIO НЕ ПОЕДЕШЬ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 696, "y": 24, "texts": [
                            { "text": "НУ НЕ УБЕГАЙ", "offset": 8 }
                        ]},
                        { "thing": "Zadov", "x": 744, "y": 80 },
                        { "thing": "Rostov", "x": 388, "y": 66 },
                        ...
                        { "macro": "EndOutsideCastle", "x": 1224, "large": true, "walls": 12, "transport": { "map": "2-3" } }
                    ]
                }
            ]
        }, {
            ...
            "areas": [
                {
                    ...
                    "creation": [
                        ...
                        { "thing": "CustomText", "x": 10, "y": 60, "texts": [
                            { "text": "ЛИБО АРМИЯ ЛИБО ЗОНА", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 160, "y": 60, "texts": [
                            { "text": "ДЕДЫ ВОЕВАЛИ И ТЫ БУДЕШЬ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 350, "y": 60, "texts": [
                            { "text": "ТЫ ТОЧНО ГОДЕН", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 500, "y": 60, "texts": [
                            { "text": "НЕ СЛУЖАТ ТОЛЬКО ПИДОРАСЫ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 650, "y": 68, "texts": [
                            { "text": "ТЫ ЧТО ПИДОРАС", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 750, "y": 74, "texts": [
                            { "text": "А", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 886, "y": 36, "texts": [
                            { "text": "СЛУЖБА ЭТО ПОЧЁТНО", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 1110, "y": 60, "texts": [
                            { "text": "ОТ ПОВЕСТКИ НЕ УКЛОНИТЬСЯ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 1300, "y": 60, "texts": [
                            { "text": "ОТ СИСIOКИ МАМКИНОЙ УЖЕ ОТОРВИСЬ", "offset": 8 }
                        ]},
                        { "thing": "CustomText", "x": 1600, "y": 64, "texts": [
                            { "text": "НЕЕЕТ ТОЛЬКО НЕ ТУДА", "offset": 8 },
                            { "text": "НЕЕЕТ ТОЛЬКО НЕ СIOДА", "offset": 8 }
                        ]},
                        { "thing": "LogoSmall", "x": 1738, "y": 48, "width": 64 },
                        ...
                        { "macro": "EndOutsideCastle", "x": 1800, "large": true, "walls": 7, "transport": { "map": "end" } }
                    ]
                }
            ]
        }, {
            ...
            "areas": [
                {
                    ...
                    "creation": [
                        ...
                        { "thing": "Stone", "x": 1712, "y": 56, "height": 56 },
                        { "thing": "Stone", "x": 1720, "y": 64, "width": 16, "height": 64 },
                        { "macro": "EndOutsideCastle", "x": 1800, "large": true, "walls": 7, "transport": { "map": "1-1" } }
                    ]
                }
            ]
        }, {
            ...
            "areas": [
                {
                    ...
                    "creation": [
                        ...
                        { "macro": "EndOutsideCastle", "x": 3008, "transport": { "map": "7-3" } },
